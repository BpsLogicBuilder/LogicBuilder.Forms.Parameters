...
{
    public class AverageOperatorParametersTest
    {
        [Fact]
        public void Constructor_SetsAllProperties()
        {
            ...
            var expectedSelectorBody = new MemberSelectorOperatorParameters("Value", new ParameterOperatorParameters("x"));
            string expectedSelectorParameterName = "x";

            // Act
            var parameters = new AverageOperatorParameters(
